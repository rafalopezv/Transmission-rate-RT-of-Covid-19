...
<br>
<br>
Aquí encuentra tablas que comparan todos los indicadores y datos antes descritos pero en formato de tabla. Puede filtrar y buscar en cada columna. 
<br>
<center><h3>Tabla del mundo: 188 países actualizados diariamente<h3></center>
...
<br>
<br>
<center><h3>Tabla de departamentos de Bolivia: actualizados diariamente<h3></center>
```{r, echo=F, warning=F, message=F}
df_dptos %>%
  merge(., codigos, all.x = T) %>% 
  mutate(
