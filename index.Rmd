...
source("codigo/limpieza_graficos.R")
...
<iframe frameBorder="0" src="https://rafalopezv.github.io/latam_rt/" width="100%" height="1500" allowtransparency="true"></iframe>

## {-}

<br>
<br>
<h1>Rt: Serie de tiempo: Departamentos</h1>
```{r, include=T, echo = F}
rt_tiempo_g[[2]]
rt_tiempo_g[[1]]
rt_tiempo_g[[3]]
...
<br>
<br>
<center>[<img src = "img/github.png"  height="60" width="80">](https://github.com/rafalopezv/covid_bolivia)</center>
<br>
<br>
<center><h1>Bases de datos utilizadas<h1></center>
<br>
...
<br>
<center>https://raw.githubusercontent.com/mauforonda/covid19-bolivia/opsoms/confirmados.csv</center>
<br>
<center>https://raw.githubusercontent.com/mauforonda/covid19-bolivia/opsoms/decesos.csv</center>
<br>
<center>https://data.worldbank.org/indicator/SP.POP.TOTL</center>
<br>
<center>https://www.boliviasegura.gob.bo/datos.php</center>
<br>
<center>https://www.ine.gob.bo/subtemas_cuadros/demografia_html/PC20106.htm</center>
<br>
<br>

<center><h1>Bases de datos para descarga<h1>

```{r, include=T, echo = F, fig.width = 10, fig.height = 7, warning = F, message = F}
deptos <- read_csv("bases/departamentos_bolivia.csv")
download_this(
  button_label = "Descarga la base de datos con información departamental",
  deptos
)
```
...
<center>
```{r, include=T, echo = F, fig.width = 10, fig.height = 7, warning = F, message = F}
mundo <- read_csv("bases/mundo_bolivia.csv")
download_this(
  button_label = "Descarga la base de datos con información de 188 países",
  mundo
)
```
